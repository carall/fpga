...
% open serial port and set its property
% instrhwinfo('serial') show useable ports
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear;
disp('setting and opening serial...');
try
    s=serial('com3');
    s.Baudrate = 9600;
    s.DataBits = 8;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%set counter
disp('setting counters...');
try
    fwrite(s,[1;2^14+1],'uint16','async');
    pause(0.5);
...
result_str = ['counter',num2str(1),': ',num2str(cnt_mat(1))];
disp(result_str);
